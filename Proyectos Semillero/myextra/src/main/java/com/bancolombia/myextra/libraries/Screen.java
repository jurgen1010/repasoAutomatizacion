...
public interface Screen extends Com4jObject {
   ...
   * @param area Mandatory com.bancolombia.myextra.ATM_AREA parameter.
   * @param wrap Mandatory com.bancolombia.myextra.ATM_WRAP parameter.
  ...
  java.lang.String getStringEx(
    ...
    int endRow,
    int endCol,
    com.bancolombia.myextra.libraries.ATM_AREA area,
    com.bancolombia.myextra.libraries.ATM_WRAP wrap,
    int attr,
    int flags);
   ...
   * @param area Mandatory com.bancolombia.myextra.ATM_AREA parameter.
   * @param wrap Mandatory com.bancolombia.myextra.ATM_WRAP parameter.
   * @param mode Mandatory com.bancolombia.myextra.ATM_PUTSTRING parameter.
  ...
  int putStringEx(
    ...
    com.bancolombia.myextra.libraries.ATM_AREA area,
    com.bancolombia.myextra.libraries.ATM_WRAP wrap,
    com.bancolombia.myextra.libraries.ATM_PUTSTRING mode,
    boolean fill);
